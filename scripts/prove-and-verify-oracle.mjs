...
const ORACLE =
  process.env.ORACLE_V2_ID ||
  "CBBO72ROVZVAC2KWYZOEN6PH2GAGFFIFFDO35FV5PGM3QWDEN4EO45PU";
...
const KYC_ROOT =
  "0ecdfe0997c23a0fe261aca9555027ffd450f0b45e3c17631ae3243c213d7cd1";
const resBE = Buffer.alloc(16);
resBE.writeBigUInt64BE(RESERVES, 8);
...
if (bad === "true") {
  console.error("tampered attestation accepted!");
  process.exit(1);
}
